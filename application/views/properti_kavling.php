            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">Listing Kavling</h1>               
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="contactForm2" class="contactForm">
          ...
          <div class="row">
            <div class="col-sm-12">
                <div class="border-btn" id="demoFont1" onclick="window.location.href='https://api.whatsapp.com/send?phone=6282135077987&text=halo%20JuraganRumah.net%0A%0AMohon%20info%20%0A%0Anama%20%3A%0Aemail%20%3A%0Adomisili%20%3A%0A%0ATerima%20kasih' "><i class="fa fa-whatsapp"></i>&nbsp;Customer Service </div>
            </div>
            <div class="col-sm-12">
