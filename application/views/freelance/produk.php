                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="<?php echo base_url('freelance/produk/add') ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Produk</a>
                        </div>
                         ...
                         <table class="table table-bordered table-hover" id="zero_config">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('freelance/produk/edit/'.$data->id_produk) ?>" class="btn btn-default btn-sm" title="Edit"><i class="fas fa-edit"></i></a>
                                        <a href="<?php echo base_url('freelance/produk/foto/'.$data->id_produk) ?>" class="btn btn-warning btn-sm" title="Foto Produk"><i class="mdi mdi-folder-multiple-image"></i></a>
...
<script>
    ...
    function view(id) {
        $.ajax({
            url : "<?php echo site_url('index.php/freelance/produk/get/')?>" + id,
            type: "GET",
            dataType: "JSON",
