...
<head>
    ...
    <title>Dashboard Agen Freelance Juragan Rumah</title>
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <a class="dropdown-item" href="<?php echo base_url('freelance/setting') ?>"><i class="ti-settings m-r-5 m-l-5"></i> Setting Akun</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo base_url('freelance/login/logout') ?>"><i class="fa fa-power-off m-r-5 m-l-5"></i> Logout</a>
                                <!-- <div class="dropdown-divider"></div>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item <?php if($this->uri->segment(2) == "dashboard"){ echo 'selected'; } ?>"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if($this->uri->segment(2) == "dashboard"){ echo 'active'; } ?>" href="<?php echo base_url('freelance') ?>" aria-expanded="false">
                                <i class="mdi mdi-view-dashboard"></i>
                                <span class="hide-menu">Dashboard Agen Freelance</span>
                            </a>
                        </li>
                        <li class="sidebar-item <?php if($this->uri->segment(2) == "profil"){ echo 'selected'; } ?>">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if($this->uri->segment(2) == "profil"){ echo 'active'; } ?>" href="<?php echo base_url('freelance/profil') ?>" aria-expanded="false">
                                <i class="mdi mdi-account"></i>
                                <span class="hide-menu">Profil</span>
                            </a>
                        </li>
                        <!-- <li class="sidebar-item <?php if($this->uri->segment(2) == "upgrade"){ echo 'selected'; } ?>">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if($this->uri->segment(2) == "upgrade"){ echo 'active'; } ?>" href="<?php echo base_url('freelance/upgrade') ?>" aria-expanded="false">
                                <i class="mdi mdi-arrow-up-bold"></i>
                                <span class="hide-menu">Upgrade</span>
                            </a>
                        </li> -->
                        <li class="sidebar-item <?php if($this->uri->segment(2) == "produk"){ echo 'selected'; } ?>">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if($this->uri->segment(2) == "produk"){ echo 'active'; } ?>" href="<?php echo base_url('freelance/produk') ?>" aria-expanded="false">
                                <i class="mdi mdi-shopping"></i>
                                <span class="hide-menu">Projek Anda</span>
                            </a>
                        </li>
                        <li class="sidebar-item <?php if($this->uri->segment(2) == "statistik"){ echo 'selected'; } ?>">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if($this->uri->segment(2) == "statistik"){ echo 'active'; } ?>" href="<?php echo base_url('freelance/statistik') ?>" aria-expanded="false">
