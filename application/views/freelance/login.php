...
<html lang="en">
<head>
	<title>Login Agen Freelance</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<?php echo form_open('freelance/login/submit', array('class' => 'login100-form validate-form')); ?>
					<span class="login100-form-title p-b-48">
						<!-- <i class="zmdi zmdi-font"></i> -->

					<span class="login100-form-head p-b-10" style="font-size: 20px;">
						Agen Freelance / Owner
					</span>
					...
					<div class="text-center p-t-38">
						<span class="txt1">
							Belum terdaftar Agen Freelance ?
						</span>
						<a class="txt2" href="<?php echo base_url('kemitraan') ?>" target="_blank">
							Daftar
						</a><br>
						<a class="txt2" href="<?php echo base_url('freelance/forgotpassword') ?>">
							Lupa Password ?
						</a>
					</div>
				<?php echo form_close(); ?>
