            ...
            <div class="blog-lst col-md-9"><br>                
                    <section class="post">
                        <div class="text-center padding-b-50">
                            <h3 class="wow"><?php echo $get->judul ?></h3>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <p class="author-category">
                                    By <a href="#"><?php echo $get->author ?> Juragan Rumah</a>
                                    in <a href="<?php echo base_url() ?>">juraganrumah.net</a>
                                </p>
                            </div>
                            <div class="col-sm-6 right" >
                                <p class="date-comments">
                                    <a href="single.html"><i class="fa fa-calendar-o"></i> <?php echo date('d M Y', strtotime($get->datetime)) ?></a>
                        ...
                        <div class="image wow">
                            <a href="#">
                                <img src="<?php echo base_url('assets/backend/fotoartikel/'.$get->foto) ?>" class="img-responsive" alt="Example blog post alt">
                            </a>
                        </div>
                        <span>
                            <?php echo $get->isi; ?>
