            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">Listing Semua Properti</h1>               
                    </div>
                </div>
            </div>
        </div>
                             ...
                             <div class="col-sm-6 col-md-4 p0">
                                <div class="box-two proerty-item">
                                    <div class="item-thumb">
                                        <a href="<?php echo site_url() ?>properti_detail?id_produk=<?php echo $su->id_produk?>&nama_produk=<?php echo $su->nama_produk?>"><img src="<?php echo base_url('assets/backend/fotoproduk/'.$su->file) ?>"></a>
                                    </div>
                                        ...
                                        <div class="col-md-12 col-xs-12">
                                            <div class="error-template">
                                                <h2>
                                                    Maaf!</h1>
                                                <h3>
                                                    Sepertinya data yang anda Cari Belum Tersedia..</h3>
                                            </div>
                                        </div>
                                <?php } ?>
                            ...
                            <div class="panel panel-default sidebar-menu" style="height: 600px;">
                                ...
                                <div class="panel-body recent-property-widget">
                                 ...
                                 <div id="lflRjR" class="lflRjR">
                                    ...
                                    <span class="btn btn-link"><a href="http://api.clickatell.com/http/sendmsg?to=628119475777&msg=Message+Body+Here"><i class="pe-7s-mail"></i>&nbsp;Message </a></span>
