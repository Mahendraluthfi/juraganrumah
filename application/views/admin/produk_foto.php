 ...
 <div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Property Anda</h4>
            <div class="ml-auto">
            ...
            <div class="card">            
                <div class="card-body">
                    <h4 class="card-title">Tambah Foto Produk</h4>                
                        <?php echo form_open_multipart('admin/produk/submit_foto', array('class' => 'form-horizontal','name' => 'frmfoto')); ?>
                    ...
                    <table class="table table-bordered table-hover" id="zero_config">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="<?php echo base_url('admin/produk/delete/'.$data->id_foto.'/'.$data->file.'/'.$data->id_produk) ?>" class="btn btn-danger" title="Hapus" onclick="return confirm('Yakin hapus foto ?')"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
