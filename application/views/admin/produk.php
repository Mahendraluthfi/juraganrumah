        ...
        <div class="col-md-12">            
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h5>Project Property</h5>
                        </div>
                        <div class="col-md-6 text-right">
                            <a href="<?php echo base_url('admin/produk/add') ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Post</a>
                        </div>
                         ...
                         <table class="table table-bordered table-hover" id="zero_config">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('admin/produk/edit/'.$data->id_produk) ?>" class="btn btn-default btn-sm" title="Edit"><i class="fas fa-edit"></i></a>
                                        <a href="<?php echo base_url('admin/produk/foto/'.$data->id_produk) ?>" class="btn btn-warning btn-sm" title="Foto Produk"><i class="mdi mdi-folder-multiple-image"></i></a>
