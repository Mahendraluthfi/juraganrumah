            ...
            <div class="col-md-12">            
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">                            
                                <?php echo form_open('admin/produk/submit_edit', array('class' => 'form-horizontal')); ?>
                                    <div class="card-body">                                    
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="kabkot" id="kabkot" class="kabkot select2 form-control custom-select" style="width: 100%;" required="required">
                                                    <option value="<?php echo $row->kabupaten ?>" selected="selected"><?php echo $kabkot ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="kecamatan" id="kec" class="kec select2 form-control custom-select" style="width: 100%;" required="required">
                                                    <option value="<?php echo $row->kecamatan ?>" selected="selected"><?php echo $kec ?></option>
                                                </select>
                                            </div>
                                        </div>                                                                                 
                                         <div class="form-group row">
