            ...
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('mitra/artikel') ?>">Artikel</a></li>
        ...
        <div class="col-md-12">            
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">            
                        <?php echo form_open_multipart('mitra/artikel/submit_edit', array('class' => 'form-horizontal')); ?>                
                            <div class="form-group row">                             
                                <label for="fname" class="col-sm-3 control-label col-form-label">Judul Artikel</label>
                                <div class="col-sm-9">
                                    <input type="text" name="judul" class="form-control" placeholder="Judul Artikel" value="<?php echo $get->judul ?>">
                                </div>                            
                            </div>
                            <div class="form-group row">                             
                            ...
                            <div class="form-group row">                             
                                ...
                                <div class="col-sm-9">
                                    ...
                                    style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $get->isi; ?></textarea> -->
                             ...
                             <div class="form-group row">                             
                                ...
                                <div class="col-sm-9">
                                    <img src="<?php echo base_url('assets/backend/fotoartikel/'.$get->foto) ?>" alt="" height="50">
                                    <input type="file" name="foto">
                                    <input type="hidden" name="id" value="<?php echo $get->id_artikel ?>">
                                </div>                            
                            </div>
                             <div class="form-group row">                             
