                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="<?php echo base_url('mitra/artikel/add') ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Artikel</a>
                        </div>                    
                    </div><hr>
                    <div class="row">                        
                        <div class="col-md-12">
                                    ...
                                    <?php $no=1; foreach ($get as $data) { ?>                                        
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo base_url('mitra/artikel/edit/'.$data->id_artikel) ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                                                <a href="<?php echo base_url('mitra/artikel/hapus/'.$data->id_artikel) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Hapus Artikel ?')"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
