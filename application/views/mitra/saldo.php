 ...
 <div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Laporan Saldo</h4>
            ...
            <div class="card card-hover">
                <div class="box bg-info">
                   ...
                   <h6 class="text-white">Proses pencairan memakan waktu 1x24 Jam</h6>
                     <button type="button" class="btn btn-primary margin-5" data-toggle="modal" <?php if(base64_decode($mitra->saldo) < 1000000){ echo 'data-target="#Modal2"'; }else{ echo 'data-target="#Modal1"'; } ?>>
                        Cairkan Saldo
                    </button>            
                </div>
            </div>                    
    ...
    <div class="modal-dialog" role="document ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                 <?php echo form_open_multipart('mitra/saldo/pull', array('class' => 'form-horizontal', 'name' => 'frm')); ?>
                    <div class="card-body">                        
                        <div class="form-group row">
                            <label for="fname" class="col-sm-3 control-label col-form-label">Nama Bank</label>
                            <div class="col-sm-9">                                
                                 <input type="text" readonly class="form-control-plaintext" value="<?php echo $mitra->nama_bank ?>" name="namabank">                                 
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="lname" class="col-sm-3 control-label col-form-label">No Rekening</label>
                            <div class="col-sm-9">                                
                                 <input type="text" readonly class="form-control-plaintext" value="<?php echo $mitra->no_rekening ?>" name="norek">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="lname" class="col-sm-3 control-label col-form-label">Atas Nama</label>
                            <div class="col-sm-9">
                                 <input type="text" readonly class="form-control-plaintext" value="<?php echo $mitra->atas_nama ?>" name="atasnama">
                            </div>
                        </div>
                        <div class="form-group row">
