            ...
            <div class="ml-auto">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('mitra/produk') ?>">Produk</a></li>
        ...
        <div class="col-md-12">            
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">                            
                            <?php echo form_open('mitra/produk/submit', array('class' => 'form-horizontal')); ?>
                                <div class="card-body">                                    
                                    ...
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 control-label col-form-label">Nama Produk</label>
                                        <div class="col-sm-9">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <?php foreach ($ktg as $dktg) { ?>                          
                                                <option value="<?php echo $dktg->id_category_produk ?>"><?php echo $dktg->nama_category ?></option>
                                            <?php } ?>
                                            </select>
                                        </div>
                                    </div>
