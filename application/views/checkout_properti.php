    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
            <header>
                <div class="row">
                    <div class="col company-details">
                        ...
                        <div>Jl. Veteran No. 48 - Semarang Semarang Jawa Tengah Indonesia</div>
                        <div> (024) 76443701 </div>
            ...
            <main>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-left">
                               ...
                               <?php $this->session->set_userdata('id',"$su->id_shop"); ?>
                            </td>
                            <td class="text-left">
                               <?php echo $su->alamat ?>
                            </td>
                ...
                <input type="hidden" name="tipe_bayar" value="<?php foreach($produk as $su ){ echo $su->type_pembayaran; } ?>">
                <tr><td><div class="form-group">
                            <h5><?php foreach($produk as $su ){ echo $su->type_pembayaran; } ?></h5>
                        </div>
                </td></tr>
                </table>
                <br>
