                    ...
                    <div class="blog-asside-right col-md-3">
                        <div class="panel panel-default sidebar-menu wow fadeInRight animated" >
                            <div class="panel-heading">
                                <h3 class="panel-title">WIDGET TEKS</h3>
                            </div>
                            <div class="panel-body text-widget">
                                <p>“Apa kau tidak malu pada mimpimu sendiri? Dalam mimpi, kau terlihat begitu kuat dan bersemangat, tapi kenyataannya mengapa kau begitu lemah?”
                                </p>
                    ...
                    <div class="blog-lst col-md-9">
                        <section class="post">
                            <div class="text-center padding-b-50">
                                <h2 class="wow fadeInLeft animated">BACA INI SEBELUM ANDA MEMBELI RUMAH</h2>
                        ...
                        <section class="post">
                            <div class="text-center padding-b-50">
                                <h2  class="wow fadeInLeft animated">GAJI KECIL TAPI INGIN PUNYA RUMAH</h2>
                                <div class="title-line wow fadeInRight animated"></div>
                            </div>
                        ...
                        <section class="post">
                            <div class="text-center padding-b-50">
                                <h2  class="wow fadeInLeft animated">CARA BELI RUMAH TANPA RIBA</h2>
                                <div  class="title-line wow fadeInRight animated"></div>
                            </div>
